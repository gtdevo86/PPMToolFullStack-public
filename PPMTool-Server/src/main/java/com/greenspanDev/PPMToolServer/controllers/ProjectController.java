...
public class ProjectController {
	...
	public ResponseEntity<?> createNewProject(
		...
		Project myProject = projectService.saveOrUpdateProject(project,principal.getName());
		return new ResponseEntity<Project>(myProject,HttpStatus.CREATED);
	}
	
	@GetMapping("/{projectId}")
	public ResponseEntity<?> getProjectById(@PathVariable String projectId,Principal principal){
		Project project = projectService.findProjectByIndentifier(projectId,principal.getName());
