...
public class ProjectTaskService {
	...
	public ProjectTask addProjectTask(String projectIndentifier,ProjectTask projectTask, String username) {
			
			Backlog backlog = projectService.findProjectByIndentifier(projectIndentifier, username).getBacklog();
	 ...
	 public Iterable<ProjectTask> findBacklogById(String projectIndentifier, String username){
		 
		 projectService.findProjectByIndentifier(projectIndentifier, username);
		 return projectTaskRepository.findByProjectIdentifierOrderByPriority(projectIndentifier);
	 }
	 
	 public ProjectTask findPTByProjectSequence(String backlog_id, String sequence_id, String username){
		 ...
		 if(!projectTask.getProjectIdentifier().equals(backlog_id)){
			 throw new ProjectNotFoundException("Project Task: '" + sequence_id + "' does not exist in project: '" + backlog_id + "'" );
		 }
		 return projectTaskRepository.findByProjectSequence(sequence_id); 
	 }
	 
	 public ProjectTask updateByProjectSequence(ProjectTask updatedTask, String backlog_id,String sequence_id, String username) {
		 ProjectTask oldTask = findPTByProjectSequence(backlog_id,sequence_id,username);
	 ...
	 public void deletePTByProjectSequence(String backlog_id,String sequence_id, String username) {
		 projectTaskRepository.delete(findPTByProjectSequence(backlog_id,sequence_id,username));
	 } 
}
